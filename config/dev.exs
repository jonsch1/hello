...
config :hello, HelloWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "JQbR2xtCqdAUZ7KVcIDNVEuA1vBThiJ4AaGB6qxo4jaIOl4J59yyeYi7/vwKQqt7",
  watchers: [
...
config :salad_ui, components_path: Path.join(File.cwd!(), "lib/hello_web/components")
